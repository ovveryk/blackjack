'''
Модуль для роботи з гральною колодою.

Містить "deck" колоду символів усіх 52 карт, по 13 карт на кожну масть.
Також містить спеціальний символ закритої карти "closed_card".
Функціонад для перемішування колоди.
